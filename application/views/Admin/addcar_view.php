    ...
    <div class="flex ml-64 p-4 gap-6">
        ...
        <div class="w-[40rem]">
            <div class="p-6 bg-white rounded-3xl shadow-lg">
                ...
                <h1 class="text-4xl font-bold mb-6 text-black">Add New Car Data</h1>

                <form method="POST" action="<?php echo base_url('Admin/Carlist_controller/add_car'); ?>" enctype="multipart/form-data">
                <?php echo form_open('Admin/Carlist_controller/add_car', ['class' => 'space-y-6']); ?>
                  <!-- Form Fields -->
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div class="p-5 space-y-2">
                            ...
                            <input type="text" id="car-name" name="car-name" required class="rounded-lg p-4 w-full text-black text-sm bg-[#f6f7f9] focus:ring-2 focus:ring-gray-300 focus:outline-none" placeholder="Input Nama Mobil">
                        </div>
                        ...
                        <div class="p-5 space-y-2">
                            ...
                            <input type="text" id="car-engine" name="car-engine" required class="rounded-lg p-4 w-full text-black text-sm bg-[#f6f7f9] focus:ring-2 focus:ring-gray-300 focus:outline-none" placeholder="Input Engine Mobil">
                        </div>
                       ...
                       <div class="p-5 space-y-2">
                        ...
                        <div class="p-5 space-y-2">
                            ...
                            <input type="text" id="car-interior-exterior" name="car-interior-exterior" required class="rounded-lg p-4 w-full text-black text-sm bg-[#f6f7f9] focus:ring-2 focus:ring-gray-300 focus:outline-none" placeholder="Input Interior and Exterior">
                        </div>

                        <div class="p-5 space-y-2">
                            <p class="font-semibold text-base font-['inter']">Seats</p>
                            <input type="number" id="car-seats" name="car-seats" required class="rounded-lg p-4 w-full text-black text-sm bg-[#f6f7f9] focus:ring-2 focus:ring-gray-300 focus:outline-none" placeholder="Input Seats">
                        </div>

                        <div class="p-5 space-y-2">
                        <p class="font-semibold text-base font-['inter']">Harga Sewa</p>
                        <input type="number" id="car-rental-price" name="car-rental-price" required class="rounded-lg p-4 w-full text-black text-sm bg-[#f6f7f9] focus:ring-2 focus:ring-gray-300 focus:outline-none" placeholder="Input Harga Sewa" min="0">
                        </div>
                   ...
                   <!-- Form Fields for Other Photos -->
                    <div class="p-5 space-y-4">
                        ...
                        <div class="p-5 space-y-2 col-span-2">
                            ...
                            <textarea id="car-overview" name="car-overview" required class="rounded-lg p-4 w-full text-black text-sm bg-[#f6f7f9] focus:ring-2 focus:ring-gray-300 focus:outline-none" rows="4" placeholder="Input Overview and Introduction"></textarea>
                        </div>

                        <div class="p-5 space-y-2 col-span-2">
                            <p class="font-semibold text-base font-['inter']">Primary Features</p>
                            <textarea id="car-primary-features" name="car-primary-features" required class="rounded-lg p-4 w-full text-black text-sm bg-[#f6f7f9] focus:ring-2 focus:ring-gray-300 focus:outline-none" rows="4" placeholder="Input Primary Features"></textarea>
                        </div>

                        <div class="p-5 space-y-2 col-span-2">
                            <p class="font-semibold text-base font-['inter']">Additional Features</p>
                            <textarea id="car-additional-features" name="car-additional-features" required class="rounded-lg p-4 w-full text-black text-sm bg-[#f6f7f9] focus:ring-2 focus:ring-gray-300 focus:outline-none" rows="4" placeholder="Input Additional Features"></textarea>
                        </div>
                        ...
                        <div class="p-5 space-y-2">
                            ...
                            <input type="number" name="consumption" id="consumption" required class="rounded-lg p-4 w-full text-black text-sm bg-[#f6f7f9] focus:ring-2 focus:ring-gray-300 focus:outline-none" placeholder="Input Consumption" step="0.1" min="0">
                        </div>


                        <div class="p-5 space-y-2">
                            <p class="font-semibold text-base font-['inter']">Power</p>
                            <input type="number" id="power" name="power" required class="rounded-lg p-4 w-full text-black text-sm bg-[#f6f7f9] focus:ring-2 focus:ring-gray-300 focus:outline-none" placeholder="Input Power">
                        </div>
                    ...
                    <div class="text-center mt-8">
                        <button type="submit" class="bg-black text-white w-full h-10 px-4 py-2 rounded-lg shadow-md hover:bg-gray-700">Add Car</button>
                    </div>
                    <?php echo form_close(); ?>
                </form>
            </div>
        ...
        <div class="w-[30rem] ml-auto preview-container bg-white overflow-auto" style="max-height: calc(100vh - 2rem); position: sticky; top: 1rem;">
            ...
            <div id="car-preview">
                <div id="preview-logo" class="mb-4">
                    <img src="" alt="Car Logo" id="preview-logo-img" class="w-[150px] h-[150px] object-cover rounded-lg">
                </div>
...
function updatePreview() {
    ...
    document.getElementById('preview-power').textContent = document.getElementById('power').value;
}
